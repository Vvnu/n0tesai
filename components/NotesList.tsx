    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          disabled={creating}
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 active:scale-95 transition-all disabled:opacity-60"
        >
          {creating
      ...
      <div className="space-y-2">
        {notes.map(note => (
          <div
            ...
            className={`group flex justify-between items-center p-4 rounded-xl bg-white border border-gray-200 hover:border-gray-300 hover:shadow-sm cursor-pointer transition-all duration-150 ${
          ...
          >
            ...
            <button
              ...
              className="ml-3 p-1.5 rounded-lg text-gray-300 hover:text-red-500 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-all"
              title="Delete note"
            >
              <Trash2 size={14} />
            </button>
